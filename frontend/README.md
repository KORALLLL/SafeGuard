...
**SafeGuard** — это система для обнаружения смысловых копий изображений, которая игнорирует фон и фокусируется на сюжете.

Ключевые особенности:
1. Идентификация сюжетных объектов
2. Игнорирование фона
3. Сравнение с базой данных
4. Обработка скриншотов сайтов
5. Анализ лиц

SafeGuard разработан на основе React с использованием TypeScript и архитектуры Feature-Sliced Design (FSD), что обеспечивает масштабируемость и поддерживаемость кода.
...
1. Склонируйте репозиторий:
   ```bash
   git clone https://github.com/safeGuard-tech/frontend.git
   cd frontend
   ```
...
1. **app** — Инициализация приложения и глобальные конфигурации (например, Chakra и роутинг).
...
5. **entities** — Модели и сущности, используемые в приложении (например, изображения).
